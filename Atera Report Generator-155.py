...
default_hashed_password = hashlib.sha512(default_password.encode()).hexdigest()
...
def login() -> None:
    ...
    def try_login() -> None:
        ...
        hashed_password = hashlib.sha512(password_value.encode()).hexdigest()
        hashed_password_encrypt = hashlib.sha1(password_value.encode()).hexdigest()
...
ui.run(title='Atera Report Generator',host='0.0.0.0', favicon=icon, reload=False, storage_secret='change-me-for-enhanced-security')
import warnings
