...
logo_img = os.path.join(base_path, '.nicegui', 'images', 'banner3.png')
login_img = os.path.join(base_path, '.nicegui', 'images', 'banner-alt.png')
...
def adminconsole() -> None:
    ...
    with ui.card().classes('absolute-center').style('background-color: #FF176B'):
        ...
        ui.label('Web Edition 1.5.5').classes('self-center').tailwind.text_color('white')
    with ui.card().classes('absolute-right').style('background-color: #FF176B'):
    ...
    with ui.card().classes('absolute-left').style('background-color: #FF176B'):
...
ui.run(title='Atera Report Generator',host='0.0.0.0', favicon=icon, reload=False, storage_secret='please-change-this-before-usage')
